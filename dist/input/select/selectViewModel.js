...
function selectViewModel(node, inputViewModel) {
    ...
    function setValuesFromOptionsObject() {
        ...
        subs.push((0, _knockout.computed)(function () {
            ...
            var newValues = _lodash2.default.toArray((0, _scalejs.evaluate)(options.values.fromArray, context.getValue) || []).filter(function (item) {
    ...
    function setValue(data) {
        var value = (0, _scalejs2.is)(data, 'object') && {}.hasOwnProperty.call(data, 'value') ? data.value : data;
